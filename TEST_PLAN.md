...
> `tests/` has an automated pytest suite (38 collected cases, runs in under a
...
- **Scheduling, away mode, and the boost/propagation mechanic don't exist
  yet** (Milestone 4). Nothing in this test plan exercises them.
