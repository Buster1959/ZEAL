<p align="center">
  <img src="custom_components/zeal/brand/icon.png" width="112" height="112" alt="ZEAL-Heat icon">
</p>
...
<p align="center">
  ...
  ZEAL-Heat brings heating control, room scheduling, temporary changes and clear
  demand information together inside Home Assistant.
</p>

<p align="center">
  <a href="#see-zeal-in-action">See ZEAL-Heat in action</a> ·
  <a href="#install-zeal">Install with HACS</a> ·
  <a href="../../wiki">Read the user guide</a>
</p>

> **Pre-V1 preview.** ZEAL-Heat is undergoing live testing and is not yet the
...
schedules, helpers and automations. ZEAL-Heat provides one guided Home Assistant
integration that understands the relationship between the heat source, each
heating zone and every room within it.

| One ZEAL-Heat integration | What it gives you |
|---|---|
...
| **Selectable learning** | Let ZEAL-Heat observe repeated household choices and offer reviewable Schedule Adaptation suggestions. Learning remains under administrator control. |
...
- **Does a room want heat?** ZEAL-Heat compares its effective setpoint with its
  measured temperature and accounts for room-level exclusions such as an open
  window or door.
- **Is the heating actuator on?** ZEAL-Heat shows the real Home Assistant switch
...
![Anonymised Home Assistant History view showing a ZEAL-Heat room's demand and actuator timeline with thermostat target and two temperature sensors](docs/images/zeal-history-room-anonymised.png)
...
## See ZEAL-Heat in action

### Set up the home you actually have

Create practical zones, attach rooms, and choose the existing Home Assistant
equipment for each room. ZEAL-Heat supports multiple TRVs and temperature sensors
per room and creates one clear room thermostat as the shared target.

![ZEAL-Heat guided zone and room setup](docs/images/zeal-zone-and-room-setup-desktop.png)
...
![ZEAL-Heat graphical seven-day room schedule](docs/images/zeal-seven-day-schedule-desktop.png)
...
![ZEAL-Heat Quick Change controls](docs/images/zeal-quick-change-desktop.png)
...
![ZEAL-Heat Away mode with an exact date range](docs/images/zeal-away-date-range-desktop.png)

## Learning that remains accountable

Learning in ZEAL-Heat is optional. An administrator enables it, and schedule changes
are never silently committed.

### Schedule Adaptation — implemented for testing

ZEAL-Heat can identify repeated manual thermostat choices across distinct days and
...
- No custom dashboard card required for the main ZEAL-Heat experience.
...
ZEAL-Heat is currently installed as a HACS custom repository:

1. Open HACS and select **Custom repositories**.
2. Add `https://github.com/Buster1959/ZEAL-Heat` as an **Integration**.
3. Download **ZEAL-Heat HVAC System**, restart Home Assistant, then add ZEAL-Heat from
   **Settings → Devices & Services → Add Integration**.

For current setup instructions, permissions, testing guidance and
troubleshooting, use the [ZEAL-Heat wiki](../../wiki).

## Project status

ZEAL-Heat is an actively tested pre-V1 project. The detailed architecture, safety
...
ZEAL-Heat is source-available under the
...
<p align="center"><strong>ZEAL-Heat</strong><br><em>Zoned, Efficient, Adaptive, Learning.</em></p>
