...
This directory preserves verified ZEAL-Heat visual assets as project records. Copies live here so documentation cleanup can proceed without losing the visual history; the original files remain in place.

## ZEAL-Heat

The [`zeal/`](zeal/) directory contains the available ZEAL-Heat brand and interface iterations in chronological order.
