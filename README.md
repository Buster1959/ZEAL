...
| 4. Scheduling (day/time/setpoint grid), calendar-driven away mode, multi-TRV boost/propagation on manual overrides | ZEAL-owned model/engine/storage complete; runtime, UI and away mode pending |
